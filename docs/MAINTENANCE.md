...
**注意 (Re599929 后 1 视频 = 1 文件夹)**:
- 项目根有 12 个标题文件夹, 每个包含该视频的所有产物 (R2 多风格 + R3 + R4 + R6)
- 不再保留 4 个 R 目录 (二创短视频文案/二创通用/生图提示词/字幕 全部删除)
- R1 转录在 `transcriptions/<title>.md` 平铺 (1 文件 1 标题, 不进标题文件夹)
- 文件名简化 (去 R 前缀, 父目录已是 1 标题): 视频号 / 小红书 / 抖音 / 公众号 / 通用二创 / 生图提示词 / 字幕

**1 视频 = 1 文件夹结构**:
```
transcriptions/<title>.md                    R1 源文件 (平铺, 12 个)
<title>/                                     1 视频 = 1 文件夹 (12 个)
├── 视频号.md                                R2 A 风格 (12 个, 默认)
├── 小红书.md                                R2 B 风格 (2 个, 可选)
├── 抖音.md                                  R2 C 风格 (2 个, 可选)
├── 公众号.md                                R2 D 风格 (2 个, 可选)
...
├── transcriptions/                    # R1 源文件 (12, 平铺 <title>.md)
└── <title>/                          # 1 视频 = 1 文件夹 (12 个)
    ├── 视频号.md                    # R2 A 风格
    ├── 小红书.md                    # R2 B (可选)
    ├── 抖音.md                      # R2 C (可选)
